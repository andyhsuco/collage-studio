...
import { PhotoLibrary } from "../upload/PhotoLibrary";
...
export function SidePanel() {
  ...
  const setCanvasPadding = useCollageStore((s) => s.setCanvasPadding);
  ...
  return (
    <aside className="flex h-full min-h-0 w-60 shrink-0 flex-col overflow-y-auto overscroll-contain border-l border-zinc-800 bg-[var(--bg-panel)] p-4 lg:w-64">
      <div className="flex flex-col gap-6">
        <PanelSection title="Photos">
          <PhotoLibrary />
        </PanelSection>

        <PanelSection title="Layouts" collapsible defaultOpen={false}>
          <LayoutPresetGrid />
        </PanelSection>

        <PanelSection title="Canvas" collapsible defaultOpen={false}>
